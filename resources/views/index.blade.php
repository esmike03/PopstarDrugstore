...
<head>
    ...
    <title>Popstart Drugstore</title>
...
<body class="font-[Nunito]">
    <header
        ...
        <div class="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
            <a class="flex items-center text-2xl font-black" href="/">
                <img src="{{ asset('IMAGES/popstar2.png') }}" class="w-48 my-0 drop-shadow-xl" alt="Xentra Logo" />
            ...
            <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                <ul class="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8  md:items-center">
                    ...
                    <li>
                        <a href="/">
                            <button class="text-white hover:text-green-400"><i class="fas fa-house"></i>
                    ...
                    <li>
                        <a href="/products">
                            <button class="text-white hover:text-green-400"><i class="fas fa-prescription-bottle"></i>
                    ...
                    <li>
                        <a href="/aboutus">
                            <button class="text-white hover:text-green-400"><i class="fas fa-question-circle"></i>
                                About us</button>
                        </a>
                    </li>
                    {{-- <li>
        ...
        <div id="animated-section"
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img id="animateRight" src="{{ asset('IMAGES/xentrahero.png') }}"
                    class="opacity-0 -translate-x-full hidden transition-all duration-1000 w-full" />
    ...
    <footer class="bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500">
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-100 sm:text-center ">© 2025 <a href="https://flowbite.com/"
                        class="hover:underline">Popstar Drugstore.</a> All Rights Reserved.
                </span>
